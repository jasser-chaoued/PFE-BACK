package com.Backend.SubscriptionBillingAndPaymentManagement.utility;
...
public class JwtTokenProvider {
    ...
    public String generateJWTToken (UserPrincipal userPrincipal){
        ...
        return JWT.create()
                .withIssuer(TEAMWILL_LLC)
                .withAudience(TEAMWILL_ADMINISTRATION)
    ...
    private com.auth0.jwt.interfaces.JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(TEAMWILL_LLC).build();
